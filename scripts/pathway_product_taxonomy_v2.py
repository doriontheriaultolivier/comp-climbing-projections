"""Map governed internal pathway contexts to human-facing product heads.

The mapping changes vocabulary, not model evidence. Every valid result still
updates the shared graph; a direct context label only controls whether the
athlete has demonstrated that product head.
"""
